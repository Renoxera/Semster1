...
//		beispielBelegung(a);
	...
	public static void beispielBelegung(AufgabenSpeicher a) {
		...
		a.fuegeAufgabeHinzu("Test2", "1", "1.0.0,0:0");
		a.fuegeAufgabeHinzu("Test3", "1", "1.1.0,0:0");
		a.fuegeAufgabeHinzu("Test4", "1", "1.1.1,0:0");
		a.fuegeAufgabeHinzu("Test5", "0", "1.1.-1,0:0");
		a.fuegeAufgabeHinzu("Test6", "1", "1.1.1,0:0");
		a.fuegeAufgabeHinzu("Test7", "0", "1.1.1,1:0");
		a.fuegeAufgabeHinzu("Test8", "1", "1.1.1,0:1");
		a.fuegeAufgabeHinzu("Test9", "1", "1.1.1,24:0");
		a.fuegeAufgabeHinzu("Test10", "1", "1.1.1,0:60");
		a.fuegeAufgabeHinzu("Test11", "true", "10.10.1000,01:00");
		a.fuegeAufgabeHinzu("Test12", "ja", "10.10.1000,01:00");
		a.fuegeAufgabeHinzu("Test13", "Ja", "10.10.1000,01:00");
		a.fuegeAufgabeHinzu("Test14", "false", "10.10.1000,01:00");
