...
public class Umrechner {
	...
	/**
	 * In der Main-Methode werden die beiden W‰hrungen inkl. ung¸ltige Eingaben
	 * abgefragt
	 * 
	 * @param args
	 */
	...
	public static void main(String[] args) {
		...
		do {
			...
			if (first > 4) {
				System.err.println("!!Ung√ºltige Eingabe, versuchs nochmal!!\n");
				continue;
			} else if (first == 0) {
				run = false;
			...
			if (first == second)
				System.out.println("Gleiche W‰hrungen, Umrechnung nicht erforderlich!\n");
			else
	...
	/**
	 * In der calculate-Methode wird die W‰hrung umgerechnet und auf 2 Stellen nach
	 * dem Komma gerundet
	 * 
	 * @param currency1 ist der Index der Augangsw‰hrung
	 * @param currency2 ist der Index der W‰hrung, in die umgerechnet werden soll
	 */
	private static void calculate(int currency1, int currency2) {
		System.out.println("Geben sie einen gew√ºnschten Betrag in " + giveCurrencySymbol(currency1) + " ein:");
	...
	/**
	 * Die giveCurrencySymbol gibt das W‰hrungssymbol abh‰ning von dem
	 * eingebebenen Index aus
	 * 
	 * @param currency ist der Index der W‰hrung, dessen Symbol ausgegeben werden
	 *                 soll
	 * @return Das entsprechende W‰hrungsszeichen,
	 */
